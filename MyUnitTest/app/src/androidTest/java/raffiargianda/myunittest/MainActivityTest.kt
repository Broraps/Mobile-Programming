...
class MainActivityTest {
    ...
    fun assertGetLuas() {
        ...
        onView(withId(R.id.btn_save)).check(matches(isDisplayed()))
        onView(withId(R.id.btn_save)).perform(click())
        onView(withId(R.id.btn_calculate_luas)).check(matches(isDisplayed()))
        onView(withId(R.id.btn_calculate_luas)).perform(click())
        onView(withId(R.id.tv_result)).check(matches(isDisplayed()))
        onView(withId(R.id.tv_result)).check(matches(withText(dummyLuas)))
    }
